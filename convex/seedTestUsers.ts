...
export const createTestUser = internalMutation({
  args: {
    ...
    // Optional basics — if provided, used instead of hardcoded defaults
  ...
  handler: async (ctx, args) => {
    ...
    // Add visibility flags for substance fields
    if (args.drinking !== undefined) optionalFields.drinkingVisible = true;
    if (args.smoking !== undefined) optionalFields.smokingVisible = true;
