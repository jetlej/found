...
export default function ReligionScreen() {
  return <BasicOptionScreen stepName="religion" field="religion" question="What are your religious beliefs?" options={OPTIONS} optionVariant="chip" scrollable importanceField="religionImportance" />;
}
