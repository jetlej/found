  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <ProfileRow
          label="Pronouns"
          value={user.pronouns || 'None'}
          unanswered={!user.pronouns}
          onPress={() => navigateTo('pronouns')}
        />
        <ProfileRow
          label="Gender"
          value={user.gender || 'None'}
          unanswered={!user.gender}
          onPress={() => navigateTo('gender')}
        />
        <ProfileRow
          label="Sexuality"
          value={user.sexuality || 'None'}
          unanswered={!user.sexuality}
          onPress={() => navigateTo('sexuality')}
        />

        <SectionHeader title="Relationship" />
        <ProfileRow
          label="Dating Intentions"
          value={formatRelationshipGoal(user.relationshipGoal)}
          unanswered={!user.relationshipGoal}
          onPress={() => navigateTo('relationship-goals')}
        />
        <ProfileRow
          label="Relationship Type"
          value={user.relationshipType || 'None'}
          unanswered={!user.relationshipType}
          onPress={() => navigateTo('relationship-type')}
        />
        ...
        <ProfileRow
          ...
          unanswered={!user.name}
          onPress={() => navigateTo('name')}
        />
        <ProfileRow
          label="Age"
          value={calculateAge(user.birthdate)}
          unanswered={!user.birthdate}
          onPress={() => navigateTo('birthday')}
        />
        <ProfileRow
          label="Age Preference"
          value={formatAgeRange(user.ageRangeMin, user.ageRangeMax, user.ageRangeDealbreaker)}
          unanswered={user.ageRangeMin == null}
          onPress={() => navigateTo('age-range')}
        />
        <ProfileRow
          label="Height"
          value={formatHeight(user.heightInches)}
          unanswered={!user.heightInches}
          onPress={() => navigateTo('height')}
        />
        <ProfileRow
          label="Location"
          value={user.location || 'None'}
          unanswered={!user.location}
          onPress={() => navigateTo('location')}
        />
        <ProfileRow
          label="Ethnicity"
          value={user.ethnicity || 'None'}
          unanswered={!user.ethnicity}
          onPress={() => navigateTo('ethnicity')}
        />
        <ProfileRow
          label="Hometown"
          value={user.hometown || 'None'}
          unanswered={!user.hometown}
          onPress={() => navigateTo('hometown')}
        />
        <ProfileRow
          label="Children"
          value={formatChildren(user.hasChildren)}
          unanswered={!user.hasChildren}
          onPress={() => navigateTo('kids')}
        />
        <ProfileRow
          label="Family Plans"
          value={formatWantsChildren(user.wantsChildren)}
          unanswered={!user.wantsChildren}
          onPress={() => navigateTo('wants-kids')}
        />

        <SectionHeader title="Beliefs" />
        <ProfileRow
          label="Religious Beliefs"
          value={user.religion || 'None'}
          unanswered={!user.religion}
          onPress={() => navigateTo('religion')}
        />
        <ProfileRow
          label="Politics"
          value={user.politicalLeaning || 'None'}
          unanswered={!user.politicalLeaning}
          onPress={() => navigateTo('politics')}
        />

        <SectionHeader title="Pets" />
        <ProfileRow
          label="Pets"
          value={user.pets || 'None'}
          unanswered={!user.pets}
        ...
        <ProfileRow
          label="Drinking"
          value={user.drinking || 'None'}
          unanswered={!user.drinking}
          onPress={() => navigateTo('drinking')}
        />
        <ProfileRow
          label="Smoking"
          value={user.smoking || 'None'}
          unanswered={!user.smoking}
          onPress={() => navigateTo('smoking')}
        />
        <ProfileRow
          label="Marijuana"
          value={user.marijuana || 'None'}
          unanswered={!user.marijuana}
          onPress={() => navigateTo('marijuana')}
        />
        <ProfileRow
          label="Drugs"
          value={user.drugs || 'None'}
          unanswered={!user.drugs}
          onPress={() => navigateTo('drugs')}
        />

        <SectionHeader title="Other" />
        <ProfileRow
          label="Tattoos"
          value={user.tattoos || 'None'}
